...
st.set_page_config(
    page_title="Real-time Voice Translation",
    page_icon="🗣️",
    layout="wide"
)
...
def load_processing_modules():
    ...
    try:
        ...
        from synthensize_translations.synthensize_translations import TranslationsSynthensizer
...
def main():
    ...
    clustering_method = st.sidebar.selectbox(
        "Clustering Method",
        ["average", "centroid", "pooling"],
        index=["average", "centroid", "pooling"].index(config['pipeline']['params']['clustering']['method']),
        help="Method for grouping segments into speakers"
    )
